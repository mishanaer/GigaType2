# Contributing to GigaType

Thanks for your interest in contributing. GigaType is an open-source,
...
- Bugs and feature requests:
  [github.com/GigaType/openwhispr/issues](https://github.com/GigaType/openwhispr/issues)
...
[GitHub's private vulnerability reporting](https://github.com/GigaType/openwhispr/security/advisories/new)
...
4. Open a pull request against `GigaType/openwhispr` `main` and fill
...
improvement helps make GigaType better.
